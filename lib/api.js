...
var Message = require('digicore-message');
...
API.prototype._addSignaturesToDigicoreTx = function(txp, t, signatures, xpub) {
...
API.prototype._applyAllSignatures = function(txp, t) {
  ...
  _.each(sigs, function(x) {
    self._addSignaturesToDigicoreTx(txp, t, x.signatures, x.xpub);
  });
};
...
API.prototype.signMessage = function(opts, cb) {
  var signature = null;
  try {
    signature = Message(opts.message).sign(opts.privateKey);
  }catch(e){
    return cb(e);
  }
